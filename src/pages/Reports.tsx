      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
            <div className="flex items-center justify-between sm:justify-start gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl shadow-sm cursor-pointer hover:bg-slate-50 transition-all w-full sm:w-auto">
            ...
            <button className="flex justify-center items-center gap-2 px-5 py-2.5 bg-blue-600 rounded-xl text-sm font-bold text-white hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 w-full sm:w-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
          <div className="col-span-1 lg:col-span-7 bg-white rounded-3xl border border-slate-200 shadow-sm p-4 md:p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              ...
              <div className="flex bg-slate-50 p-1 rounded-xl border border-slate-100 w-full sm:w-auto">
                <button className="flex-1 sm:flex-none px-4 py-1.5 bg-white rounded-lg text-[10px] font-black text-[#003896] shadow-sm">Day</button>
                <button className="flex-1 sm:flex-none px-4 py-1.5 text-[10px] font-black text-slate-400 hover:text-slate-600">Week</button>
                <button className="flex-1 sm:flex-none px-4 py-1.5 text-[10px] font-black text-slate-400 hover:text-slate-600">Month</button>
              </div>
            </div>
            <div className="h-[250px] md:h-[300px] relative">
              {/* Simplified chart representation */}
              <div className="absolute inset-0 flex items-end justify-between px-1 md:px-2">
                {[40, 60, 45, 70, 55, 80, 65].map((h, i) => (
                  <div key={i} className="w-8 md:w-12 bg-slate-50 rounded-t-lg relative group">
            ...
            <div className="flex justify-between mt-4 px-1 md:px-2">
              {['08 NOV', '09 NOV', '10 NOV', '11 NOV', '12 NOV', '13 NOV', 'TODAY'].map((d, i) => (
                <span key={d} className={`text-[8px] md:text-[10px] font-black text-slate-400 ${i % 2 !== 0 ? 'hidden md:inline' : ''}`}>{d}</span>
              ))}
            </div>
          </div>

          <div className="col-span-1 lg:col-span-5 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/50">
                    <th className="px-6 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest min-w-[150px]">Department</th>
                    <th className="px-4 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center min-w-[80px]">Staff</th>
                    <th className="px-4 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center min-w-[80px]">Efficiency</th>
                    <th className="px-6 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest text-right min-w-[150px]">Budget Utilization</th>
                  </tr>
                </thead>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="col-span-1 lg:col-span-4 bg-white rounded-3xl border border-slate-200 shadow-sm p-6 md:p-8">
          ...
          <div className="col-span-1 lg:col-span-8 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-4 md:p-6 border-b border-slate-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                <div className="relative w-full sm:w-auto">
                  <input type="text" placeholder="Search by Department..." className="w-full sm:w-64 bg-slate-50 border border-slate-100 pl-10 pr-4 py-2 rounded-xl text-xs font-medium outline-none focus:border-[#003896] transition-all" />
                ...
                <button className="p-2.5 bg-slate-50 border border-slate-100 rounded-xl text-slate-400 hover:text-slate-700 transition-all w-full sm:w-auto flex justify-center">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/50">
                    <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest min-w-[100px]">Reference</th>
                    <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest min-w-[150px]">Dept. / Unit</th>
                    <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center min-w-[100px]">Hours</th>
                    <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest text-right min-w-[100px]">Est. Cost</th>
                    <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center min-w-[120px]">Intensity</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-50">
